...
export default async function PerfilFeirantePage() {
  ...
  const nome = (profile as any)?.nome || user.user_metadata?.nome || "Feirante"
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-md mx-auto min-h-screen bg-gray-50 flex flex-col">
        ...
        <header className="px-5 pt-12 pb-5">
          ...
          <h1 className="text-3xl font-bold" style={{ color: "#1A1A1A" }}>Meu Perfil</h1>
        </header>
            ...
            <div className="divide-y divide-gray-100">
              ...
              <div className="flex items-center gap-3 px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">Feirante</p>
                </div>
              </div>
            </div>
          </div>
