      ...
      {editing ? (
        <div className="mt-1.5 flex items-center gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-[#E8560A]/30 focus:border-[#E8560A] transition"
          ...
          <button
            onClick={handleSave}
            disabled={isPending}
            className="p-2 rounded-xl text-white transition-opacity hover:opacity-90 disabled:opacity-50"
        ...
        <div className="mt-1.5 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-gray-400 hover:text-[#E8560A] hover:bg-orange-50 transition-colors"
